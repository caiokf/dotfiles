...
name: oracle
description: >-
  Second-opinion reasoning model for complex analysis, debugging, architecture review, and design decisions. Use when the main agent needs a deeper or alternative perspective on a hard problem.
model: opus
