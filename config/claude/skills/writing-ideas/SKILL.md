---
name: writing-ideas
description: Use when researching tools, technologies, or approaches to create a planning/ideas document - guides parallel documentation crawling, synthesis, critical evaluation with real-world research, and honest rewriting based on what actually works in production vs marketing claims
---

# Writing Ideas Documents
