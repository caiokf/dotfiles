...
**Personal skills live in agent-specific directories (`~/.claude/skills` for Claude Code, `~/.codex/skills` for Codex)**. Unless explicitly instructed, just create it in `~/.opencode/skills`.
...
A **skill** is a reference guide for proven techniques, patterns, or tools. Skills help future Coding Agents find and apply effective approaches.
...
**Critical for discovery:** Future Agents needs to FIND your skill
...
How future Agents finds your skill:
